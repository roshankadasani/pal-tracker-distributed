...
public class FlowTest {
    ...
    private Appligit cationServer registrationServer = new ApplicationServer(workingDir + "/../applications/registration-server/build/libs/registration-server.jar", "8883");
